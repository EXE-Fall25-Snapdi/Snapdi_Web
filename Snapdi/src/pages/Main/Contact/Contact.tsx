...
function Contact() {
  return (
    ...
    <div className="bg-white w-full min-h-screen text-black overflow-hidden pt-[215px]">
      ...
      */}
      <section className="relative w-full flex items-center overflow-hidden">
        <div className=" w-8/12 pt-8 bg-gradient-to-r from-[#00EA80] to-[#12C6A3] lg:rounded-b-[6rem] rounded-[4rem] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="">
              <img
                src={contact1}
                alt="Snapdi Mascot"
                // Dùng margin âm để đẩy hình ảnh ra lề trái
                className=""
              />
            </div>
            ...
            <div className=" z-10 text-left flex flex-col items-start justify-start">
              <p className="text-[150px] text-white lg:text-8xl font-extrabold mb-4">
                LIÊN HỆ
              </p>
          ...
          <form className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="flex flex-col gap-6">
              <input
                ...
                className="w-full p-4 rounded-xl border-2 focus:outline-none focus:ring-2 focus:ring-[#00E075] text-base"
              />
              <input
                type="email"
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex justify-start lg:justify-end">
                <button
                  type="submit"
                  className="bg-gradient-to-r from-[#00EA80] to-[#12C6A3] text-white text-lg font-bold py-3 px-10 rounded-lg hover:opacity-90 transition-opacity"
                >
                  GỬI PHẢN HỒI
                </button>
              </div>
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex items-start gap-5">
                <div className="bg-black text-white rounded-full w-12 h-12 flex-shrink-0 flex items-center justify-center">
                ...
                <div>
                  <h3 className="text-xl font-bold text-black mb-1">Địa chỉ</h3>
              ...
              <div className="flex items-start gap-5">
                <div className="bg-black text-white rounded-full w-12 h-12 flex-shrink-0 flex items-center justify-center">
                  ...
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"><path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.06-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" /></svg>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-black mb-1">Số điện thoại</h3>
                  <p className="text-base text-gray-700">012345678</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-5">
                <div className="bg-black text-white rounded-full w-12 h-12 flex-shrink-0 flex items-center justify-center">
                  ...
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"><path d="M2.003 5.884L10 10.417l7.997-4.533A2 2 0 0018 4H2a2 2 0 00-1.997 1.884z" /><path d="M18 8.118l-8 4.533L2 8.118V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" /></svg>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-black mb-1">Email</h3>
                  <p className="text-base text-gray-700">snapdi.co@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 mt-4">
                {/* Facebook */}
                <a href="#" aria-label="Facebook" className="bg-black text-white! rounded-full w-12 h-12 flex items-center justify-center hover:opacity-80 transition-opacity">
                  {/* SVG Icon Facebook (Placeholder) */}
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" /></svg>
                </a>
                {/* TikTok */}
                <a href="#" aria-label="TikTok" className="bg-black text-white! rounded-full w-12 h-12 flex items-center justify-center hover:opacity-80 transition-opacity">
